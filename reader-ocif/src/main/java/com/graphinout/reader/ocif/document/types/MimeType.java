...
public class MimeType extends OcifType {
    ...
    public static MimeType of(IJsonValue jsonValue) throws IllegalStateException {
        return new MimeType(jsonValue.asString());
    }
