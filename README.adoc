...
- https://gtfs.org/[GTFS] transit feeds (stations and adjacencies as a graph))
...
****
https://GraphInOut.com[Convert any graph file format to GraphML and Connected JSON (CJ) online for free with 🦋 GraphInOut.com]
****
...
== Questions?
image:https://deepwiki.com/badge.svg[Ask DeepWiki, link="https://deepwiki.com/Calpano/graphinout"]

== Background: Graph Formats
There are so many different formats, that we spun them off in their own registry: https://github.com/Calpano/graph-format-registry[]
...
Their edges can have two endpoints (bi-edges) or many endpoints (hyper-edges).
