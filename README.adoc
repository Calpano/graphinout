...
* link:reader-graphml/graphml-spec.adoc/[GraphML] (<- our notes about the format)
...
.Supported
* Connected JSON (CJ) https://j-s-o-n.org[spec]
...
== Usage
{gio} can be used as a Java library to read format X and write to Y.
Or use the https://GraphInOut.com[free online service].
