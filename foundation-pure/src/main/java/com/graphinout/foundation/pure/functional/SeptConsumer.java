...
/**
 * Represents an operation that accepts 7 input arguments and returns no result. This is the 7-arity specialization of
 * {@link Consumer}. Unlike most other functional interfaces, {@code SeptConsumer} is expected to operate via side
 ...
 */
@FunctionalInterface
public interface SeptConsumer<K, L, M, O, P, Q, R> {

    /**
     * Performs this operation on the given seven arguments.
     *
     ...
     */
    void accept(K k, L l, M m, O o, P p, Q q, R r);
