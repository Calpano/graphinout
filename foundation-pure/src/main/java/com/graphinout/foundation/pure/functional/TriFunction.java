...
/**
 * Represents a function that accepts three arguments and produces a result. This is the trhee-arity specialization of
 * {@link Function}.
 *
 * <p>
 ...
 */
@FunctionalInterface
public interface TriFunction<K, L, M, R> {
     ...
     */
    default <V> TriFunction<K, L, M, V> andThen(final Function<? super R, ? extends V> after) {
        Objects.requireNonNull(after);
        return (final K k, final L l, final M m) -> after.apply(apply(k, l, m));
    }
