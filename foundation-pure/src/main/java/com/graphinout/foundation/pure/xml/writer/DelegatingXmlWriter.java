package com.graphinout.foundation.pure.xml.writer;
...
public class DelegatingXmlWriter extends BaseXmlHandler implements XmlWriter {
    ...
    public DelegatingXmlWriter(XmlWriter... writers) {this.writers.addAll(Java9.List.of(writers));}
    ...
    private void forEachWriter(ThrowingConsumer<XmlWriter, Exception> consumer) {
        writers.forEach(ThrowingConsumer.toNonThrowing(consumer));
    }
