...
/**
 * Represents an operation that accepts 4 input arguments and returns no result. This is the 4-arity specialization of
 * {@link Consumer}. Unlike most other functional interfaces, {@code QuadConsumer} is expected to operate via
 * side effects AND the return value.
 *
 * <p>
 * This is a functional interface whose functional method is {@link #acceptAndFilter(Object, Object, Object, Object)}.
 *
 ...
 */
@FunctionalInterface
public interface QuadConsumerFilter<K, L, M, O> {
     ...
     */
    boolean acceptAndFilter(K k, L l, M m, O o);
