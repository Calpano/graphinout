...
import static com.graphinout.foundation.pure.json.JsonEvent.Type.ArrayEnd;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.ArrayStart;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.DocumentEnd;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.DocumentStart;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.ObjectEnd;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.ObjectStart;
import static com.graphinout.foundation.pure.json.JsonEvent.Type.PropertyName;
