...
features/data-encoding/data-enc-apos.graphml.xml:: Auto-create a missing `<key>`
features/svgnode/data-with-whitespace.graphml.xml:: Drop a `<data xml:space="preserve">` attribute
