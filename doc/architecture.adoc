...
Converts an incoming Graph API stream (`GioWriter`) to a GraphML/XML stream (`IGraphmlWriter`).
...
- GioWriter: Knows how to map to GraphML model and calls `IGraphmlWriter`
