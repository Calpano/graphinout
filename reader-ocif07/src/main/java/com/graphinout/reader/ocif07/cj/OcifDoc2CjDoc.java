...
import com.graphinout.reader.ocif07.cj.OcifCj.OcifInCj;
...
import com.graphinout.reader.ocif07.document.extension.canvas.CjDocumentCanvasExtension;
...
import com.graphinout.reader.ocif07.document.extension.relation.CjLabelRelationExtension;
...
import com.graphinout.reader.ocif07.document.extension.representation.CjLanguageRepresentationExtension;
        ...
        for (IOcifExtension ext : ocifRelation.extensions()) {
            switch (ext) {
                ...
                case EdgeRelationExtension edge -> {
                    assert Objects.equals(edge.typeName(), OCIF.Type.OCIF_EDGE);
