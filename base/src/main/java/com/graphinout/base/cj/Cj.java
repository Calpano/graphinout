...
public class Cj {
    ...
    public static final String SCHEMA_ID = "https://j-s-o-n.org/schema/cj-7.0.0.json";
    public static final String SCHEMA_RESOURCE = "/schema/cj/cj-schema.json";

    public static final String SCHEMA_URL = "https://j-s-o-n.org/schema/cj-7.0.0.json";
