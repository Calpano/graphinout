...
public interface JsonElementWriter {
     ...
     * JSON String
     */
    void stringCharacters(String s) throws JsonException;

    /**
     * JSON String
     */
    void stringEnd() throws JsonException;

    /**
     * JSON String
     */
    void stringStart() throws JsonException;
     ...
     *
     * <li>{@link #objectStart()}
     * <li>{@link #whitespaceCharacters(String)} '\n    '
     * <li>{@link #onKey(String)} 'foo'
     *
     * @param s
