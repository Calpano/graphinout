...
The file `with-svg--INVALIDxml.graphml.xml` causes errors when parsing.
Even the much simpler `with-svg-SIMPLER--INVALIDxml.graphml.xml` fails to be parsed.
...
[source,xml]
----
include::with-svg-SIMPLER--INVALIDxml.graphml.xml[]
----
