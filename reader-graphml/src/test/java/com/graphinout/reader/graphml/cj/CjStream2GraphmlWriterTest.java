...
class CjStream2GraphmlWriterTest {
    ...
    void test1() {
        ...
        assertThat(json).isEqualTo("""
                {"$schema":"https://j-s-o-n.org/schema/cj-8.0.0.json","connectedJson":{"versionDate":"2026-01-15","versionNumber":"8.0.0"},"graphs":[{"id":"graph-1","nodes":[{"id":"node-1A-withGraph","graphs":[{"id":"graph-1A-1"}]},{"id":"node-1A-empty"}]}]}""");
    }
    ...
    void test2() {
        ...
        String json = runPipeline(doc);
        assertThat(json).isEqualTo("""
                {"$schema":"https://j-s-o-n.org/schema/cj-8.0.0.json","connectedJson":{"versionDate":"2026-01-15","versionNumber":"8.0.0"},"graphs":[{"id":"graph-1","nodes":[{"id":"node-1A"},{"id":"node-1B"}],"edges":[{"endpoints":[{"node":"node-1A","direction":"in"},{"node":"node-1B","direction":"out"}]}]}]}""");
